...
export function Navbar() {
  ...
  useEffect(() => {
    ...
    if (isIos() && !isStandalone()) {
       setIsInstallable(true); // Technically installable via share menu
        ...
        <div className="flex items-center justify-between h-16 gap-2">
          ...
          <div className="flex items-center gap-2 sm:gap-3 justify-end">
            ...
            <a
              ...
              className="inline-flex items-center px-3 py-1.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-700 transition-all h-[40px] sm:h-[44px] justify-center shrink-0 text-xs font-bold"
            >
              Contact
            </a>
